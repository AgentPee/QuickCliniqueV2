            ...
            modelBuilder.Entity("QuickClinique.Models.Schedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "Date" }, "IX_Schedules_Date");

                    b.HasIndex(new[] { "IsAvailable" }, "IX_Schedules_IsAvailable");

                    b.HasIndex(new[] { "Date", "IsAvailable" }, "IX_Schedules_Date_IsAvailable");

                    b.HasIndex(new[] { "Date", "StartTime" }, "IX_Schedules_Date_StartTime");
